...
use grid::GridItem;
use theme::{color_wheel_cursor, color_wheel_line, Theme};
...
pub fn draw(f: &mut Frame, app: &App) {
    ...
    render_header(f, root[0], app, theme);
    render_body(f, root[1], app, theme);
    render_footer(f, root[2], app, theme);
}
...
fn render_body(f: &mut Frame, area: Rect, app: &App, theme: Theme) {
    ...
    render_left_panel(f, cols[0], app, theme);
    render_center_panel(f, cols[1], app, theme);
    render_right_panel(f, cols[2], app, theme);
}
...
fn render_center_panel(f: &mut Frame, area: Rect, app: &App, theme: Theme) {
...
fn render_right_panel(f: &mut Frame, area: Rect, app: &App, theme: Theme) {
